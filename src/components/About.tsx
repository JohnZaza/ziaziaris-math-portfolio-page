  ...
  return (
    <section id="about" className="py-16 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            <h3 className="text-2xl font-bold text-gray-900 mb-6">{t("about.philosophyTitle")}</h3>
            <p className="text-gray-600 mb-6 leading-relaxed">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="flex items-center">
                <GraduationCap className="w-6 h-6 text-blue-600 mr-3" />
                <span className="text-gray-700">{t("about.points.degree")}</span>
              </div>
              <div className="flex items-center">
                <Target className="w-6 h-6 text-green-600 mr-3" />
                <span className="text-gray-700">{t("about.points.results")}</span>
              </div>
              <div className="flex items-center">
                <Heart className="w-6 h-6 text-red-600 mr-3" />
                <span className="text-gray-700">{t("about.points.passion")}</span>
              </div>
              <div className="flex items-center">
                <Star className="w-6 h-6 text-yellow-600 mr-3" />
                <span className="text-gray-700">{t("about.points.methods")}</span>
              </div>
            </div>
          </div>

          <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-2xl p-8">
            <h3 className="text-2xl font-bold text-gray-900 mb-6">{t("about.differenceTitle")}</h3>
            <ul className="space-y-4">
              <li className="flex items-start">
                <div className="w-2 h-2 bg-blue-600 rounded-full mt-3 mr-4 flex-shrink-0"></div>
                <div>
                  <strong className="text-gray-900">{t("about.bullets.personalized.title")}:</strong>
                  <span className="text-gray-600 ml-2">{t("about.bullets.personalized.desc")}</span>
                </div>
              </li>
              <li className="flex items-start">
                <div className="w-2 h-2 bg-green-600 rounded-full mt-3 mr-4 flex-shrink-0"></div>
                <div>
                  <strong className="text-gray-900">{t("about.bullets.realworld.title")}:</strong>
                  <span className="text-gray-600 ml-2">{t("about.bullets.realworld.desc")}</span>
                </div>
              </li>
              <li className="flex items-start">
                <div className="w-2 h-2 bg-purple-600 rounded-full mt-3 mr-4 flex-shrink-0"></div>
                <div>
                  <strong className="text-gray-900">{t("about.bullets.confidence.title")}:</strong>
                  <span className="text-gray-600 ml-2">{t("about.bullets.confidence.desc")}</span>
                </div>
              </li>
              <li className="flex items-start">
                <div className="w-2 h-2 bg-orange-600 rounded-full mt-3 mr-4 flex-shrink-0"></div>
                <div>
                  <strong className="text-gray-900">{t("about.bullets.support.title")}:</strong>
                  <span className="text-gray-600 ml-2">{t("about.bullets.support.desc")}</span>
                </div>
              </li>
            </ul>
          </div>
